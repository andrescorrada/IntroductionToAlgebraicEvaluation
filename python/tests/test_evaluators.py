...
from ntqr.r2.evaluators import ErrorIndependentEvaluation, SupervisedEvaluation
...
def test_supervised_prevalences():
    ...
    assert supervised_eval.evaluation == {
        'accuracies': [{'a': Fraction(3737, 5687),
                       ...
                       {'a': Fraction(1260, 5687),
                        'b': Fraction(29744, 31155)},
                       {'a': Fraction(4746, 5687),
                        'b': Fraction(4168, 6231)}],
        'pair_correlations': {
            'a': {(0, 1): Fraction(-4011945936, 183928777703),
                  (0, 2): Fraction(23132321875, 183928777703),
                  (1, 2): Fraction(356689875, 3913378249)},
            'b': {(0, 1): Fraction(678533304416, 3360011449875),
