...
"""Algebrai postulates for the logic of evaluation on unlabeled R=2 tests.
    ...
    across the different items used in the evaluation. This is the semantic
    interpretation.
    ...
    two responses possible for each question. This is the syntactic 
    interpretation.
    Mathematically, there are also two different ways to formulate each
    postulate. The first is in the "percentage" space - the evaluation is
    given in terms of integer ratios. The second is in the "integer" space
...
class IntegerAxioms:
    ...
    tests. Statistics of correctness are given as integers.
    """
...
if __name__ == "__main__":
    ...
    print(PercentageAxioms.pia)
    print(PercentageAxioms.pib)
    print(PercentageAxioms.pja)
    print(PercentageAxioms.pjb)
    print(PercentageAxioms.pka)
    print(PercentageAxioms.pkb)

    print(PercentageAxioms.prelances_sum_to_one)
    pprint(PercentageAxioms.single_binary_classifier_generating_set)
